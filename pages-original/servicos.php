...
include("partial/header.php") ?>
    ...
    <div class="medium-7 large-6 columns">
        ...
        <p class="subheader">Estamos equipados e preparados para ser a extensão da sua fábrica. Temos equipamentos de ponta e experiência para orientá-lo da melhor forma para produzir o seu produto.<br>
            ...
            Na Rossina Estamparia você pode comprar o produto pronto ou terceirizar parcialmente de acordo com o seu volume de produção.<br>
            Temos oito impressoras digitais para agilidade em amostras e produção, duas calandras, máquinas auxiliares na preparação de papéis, abridora de tecido, rebobinadora de tecido com alinhamento e controle de tensão, rameta com foulard para acabamentos de impermeabilização e coating, quatro prensas de bandeja, duas estufas termofixadoras à gás e elétrica, impressora digital industrial da Kornit, duas máquinas de recorte e impressora de etiquetas.<br>
