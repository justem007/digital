...
$(function() {
	$( "#calendario" ).datepicker({
		...
		dayNames: ['Domingo','Segunda_feira','Terça-feira','Quarta-feira','Quinta-feira','Sexta-feira','Sábada','Domingo'],
		dayNamesMin: ['D','S','T','Q','Q','S','S','D'],
		dayNamesShort: ['Domingo','Segunda-feira','Terça-feira','Quarta-feira','Quinta-feira','Sexta-feira','Sábada','Domingo'],
	...
	$( "#anim" ).change(function() {
		$( "#calendario" ).datepicker( "option", "drop", $( this ).val() );
	});
});