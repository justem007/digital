<div class="callout primary">
                ...
                <span class ="text-align" style="color: #069">
                    ...
                    Terceirize seu produto ou produção, ganhe tempo para idéias e negócios.
                </span>
...
<div class="row small-up-1 medium-up-1 large-up-1">
    ...
    <div class="column">
        <div class="">
            ...
            <p class="subheader  text-center"> VAMOS TRABALHAR JUNTOS ?<br><br>
    ...
    <div class="column">
        <div class="">
            ...
            <p class="subheader  text-center"> ACREDITE NO SEU POTENCIAL !!!<br><br>
                ...
                - Impressão digital direta (DTG) 100% algodão ou misturas para camisas adulto, infantil, feminino, mangas ou placas.<br>
                - Reprodução e arte finalização de estampas exclusivas com rapport para metro corrido, localizados e full print.<br>
                - Transferência sublimática em prensa ou calandra.<br>
                - Dublagem com entretela em qualquer tipo e composição de tecidos.<br>
                - Transfer de Recorte.<br>
                - Impermeabilização e tratamento de tecidos.<br>
                - Impressão sublimática em fitas e cadarços.<br>
                - Confecção ou impressão de banners de grande formato para comunicação visual.
                - Impressão e venda de tecidos personalizados para decoração.<br><br>
    ...
    <div class="row small-up1 medium-up-1 large-up-2">
        <div class="column">
            <h1 class="titulo">Use nossa Web-Logística - Ideal para e-commerce</h1>
