...
<div class="row">
    <div class="medium-4 large-4 small-12 columns">
        ...
        <div class="card">
            ...
            <div class="content">
                <h3 class="titulo card-title">Revenda camisas masculinas e femininas personalizadas sob demanda</h3>
                <p class="subheader">
                    ...
                    Pedido mínimo de uma peça.
                </p>
                <p class="subheader">CAMISAS MASCULINA ALGODÃO
                    - CAMISAS MASCULINA POLIÉSTER  <br>etc ...
                </p>
            </div>
            <div class="action">
                <a href='camisetas.php' class="expanded button">saiba mais...</a>
            </div>
        </div>
    </div>
    <br>
...
<div class="row small-up1 medium-up-1 large-up-2">
    <div class="column">
        <br>
        <p class="subheader color-azul">Cadastre-se agora produção limitada !
