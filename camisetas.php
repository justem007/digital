...
<div class="callout primary">
    <h1 class="subheader tituloh1 text-center">
        <span class="text-align" style="color: #069">
            ...
            Terceirize seu produto ou produção, <i class="fi-lightbulb"> ganhe tempo para idéias <i class="fi-lightbulb"></i> e <iclass="fi-dollar"> negócios <i class="fi-dollar"></i> .<br>
...
<div class="row small-up-1 medium-up-1 large-up-3">
    ...
    <div class="column">
        <table>
            ...
            <tfoot>
            <tr>
                <td colspan="3">Desenvolvimento de peça piloto – R$ Consulte<br>
                    - obs: Valor cobrado para produção ser feita conosco. No caso de não fazer a produção será entregue
                    somente a peça piloto. A modelagem não será entregue. Os preços podem ser alterados sem aviso
                    prévio.
                </td>
            </tr>
            </tfoot>
...
<div class="row small-up-1 medium-up-1 large-up-3">
    <h2 class="titulo text-center">Camisa masculina gola V <br>( transpasse )<br> Malha 30.1 penteada <br>100% algodão
    </h2><br>
    <div class="column">
        <a class="imagelink"
...
<div class="callout">
    <div class="row small-up-1 medium-up-1 large-up-3">
        <h2 class="titulo text-center">Camisa masculina Raglan manga curta <br> Malha 30.1 penteada <br>100% algodão
        </h2>
        <div class="column">
            <a class="imagelink"
        ...
        <div class="column">
            <a class="imagelink"
               href="images/camisas/mockup/mockup/baby-look-v/branco/Baby-look-gola-v-branca-com-frente-costa-1000.jpg">
                <img
                    src="images/camisas/mockup/mockup/baby-look-v/branco/Baby-look-gola-V-(-biquinho-)-branca-frente-costa.jpg"></a>
            <div class="b-color-picker b-color-picker--alt">
                <div class="b-color-picker__box">
                    <div class="">
                        <a class="imagelink"
