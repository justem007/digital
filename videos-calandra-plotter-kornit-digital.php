    ...
    <div class="small-up-1 medium-up-2 large-up-3">
        ...
        <div class="column">
            ...
            <a class="video" href="embed/video/mp4/plotter-dx7-subli-corrido-listrado-diagonal.mp4">
                <img class="thumbnail float-left" src="embed/video/imagem-play/print5.jpg"/>
            </a>
        </div>
        <hr class="hr-linha">
        <div class="column">
            ...
            <a class="video" href="embed/video/mp4/korni-sobre-bolso-peito.mp4">
                <img class="thumbnail float-left" src="embed/video/imagem-play/print3.jpg"/>
            </a>
        </div>
        <div class="column">
            <p class="subheader titulo">
            ...
            <a class="video" href="embed/video/mp4/kornit-malha-branca.mp4">
                <img class="thumbnail float-left" src="embed/video/imagem-play/print4.jpg"/>
            </a>
        </div>
        <div class="column">
            <p class="subheader titulo">
            ...
            <a class="video" href="embed/video/mp4/kornit-malha-preta.mp4">
                <img class="thumbnail float-left" src="embed/video/imagem-play/print2.jpg"/>
            </a>
        </div>
        <div class="column">
            <p class="subheader titulo">
            ...
            <a class="video" href="embed/video/mp4/camisetas-camisas-full-print.mp4">
                <img class="thumbnail float-left" src="embed/video/imagem-play/print8.jpg"/>
            </a>
        </div>
        <div class="column">
            <p class="subheader titulo">
            ...
            <a class="video" href="embed/video/mp4/calandra-rolo-rolo-full-print-modelada3.mp4">
                <img class="thumbnail float-left" src="embed/video/imagem-play/modelada2.jpg"/>
            </a>
        </div>
        <div class="column">
            <p class="subheader titulo">
            ...
            <a class="video" href="embed/video/mp4/calandra-rolo-rolo-full-print-modelada1.mp4">
                <img class="thumbnail float-left" src="embed/video/imagem-play/modelada.jpg"/>
            </a>
        </div>
        <div class="column">
            <p class="subheader titulo">
            ...
            <a class="video" href="embed/video/mp4/plotter-dx5.5-subli-corrido-chapado-preto.mp4">
                <img class="thumbnail float-left" src="embed/video/imagem-play/chapado-preto.jpg"/>
            </a>
        </div>
        <div class="column">
            <p class="subheader titulo">
